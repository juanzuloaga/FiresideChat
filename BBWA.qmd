...
Welcome to bird model evaluation! Below are the model product inputs and outputs for evaluation, divided across seven categories. Within, each category there will be several tasks. Note that some categories are in-progress. Please use this Google form [BBWA-BCR-71](https://docs.google.com/forms/d/1xhekH7fj2461LX_AAbN8Md1mLibKmaGo4mF_FexQm3M/edit) to provide your feedback on each section of the model cycle.
