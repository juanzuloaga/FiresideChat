...
write.csv(covlist_sel, "./covlist_sel.csv")
...
#### Task: *We would like to know if there are outliers and/or a truncation value that modelers might be aware of.*
...
t5 <- rowid_to_column(bird_d)
dim(bird)

write.csv(bcrlist_sel, "./data/bcrlist_sel.csv")
...
bcrlist_sel <- read.csv("./data/bcrlist_sel.csv")
...
#### Task: *Please identify misidentifications, migratory individuals, or surprises*
...
###### *Task: Please identify areas that are too high or too low density, if any.*
...
This map shows.................. \###### Task: *Are here areas that are surprising?*
...
###### Task: *Are here areas that are surprising?*
